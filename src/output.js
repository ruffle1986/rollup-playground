...
var __moduleExports$8 = warning$2;
...
var warning$3 = __moduleExports$8;
...
ReactComponent$1.prototype.setState = function (partialState, callback) {
  !((typeof partialState === 'undefined' ? 'undefined' : _typeof(partialState)) === 'object' || typeof partialState === 'function' || partialState == null) ? invariant$3(false, 'setState(...): takes an object of state variables to update or a function which returns an object of state variables.') : void 0;
...
function mergeIntoWithNoDuplicateKeys(one, two) {
  !(one && two && (typeof one === 'undefined' ? 'undefined' : _typeof(one)) === 'object' && (typeof two === 'undefined' ? 'undefined' : _typeof(two)) === 'object') ? invariant$4(false, 'mergeIntoWithNoDuplicateKeys(): Cannot merge non-objects.') : void 0;
...
var ReactClass$1 = {
  ...
  createClass: function createClass(spec) {
    var Constructor = function Constructor(props, context, updater) {
      ...
      !((typeof initialState === 'undefined' ? 'undefined' : _typeof(initialState)) === 'object' && !Array.isArray(initialState)) ? invariant$4(false, '%s.getInitialState(): must return an object or null', Constructor.displayName || 'ReactCompositeComponent') : void 0;
...
var ReactComponentTreeHook$1 = {
  onSetChildren: function onSetChildren(id, nextChildIDs) {
    ...
    for (var i = 0; i < nextChildIDs.length; i++) {
      ...
      !(nextChild.childIDs != null || _typeof(nextChild.element) !== 'object' || nextChild.element == null) ? invariant$6(false, 'Expected onSetChildren() to fire for a container child before its parent includes it in onSetChildren().') : void 0;
...
var EventPluginHub$1 = {
  ...
  putListener: function putListener(inst, registrationName, listener) {
    !(typeof listener === 'function') ? invariant$11(false, 'Expected %s listener to be a function, instead got type %s', registrationName, typeof listener === 'undefined' ? 'undefined' : _typeof(listener)) : void 0;
...
function toArray$2(obj) {
  ...
  !(!Array.isArray(obj) && ((typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) === 'object' || typeof obj === 'function')) ? invariant$21(false, 'toArray: Array-like object expected') : void 0;
...
function measureLifeCyclePerf(fn, debugID, timerType) {
  ...
  ReactInstrumentation$7.debugTool.onBeginLifeCycleTimer(debugID, timerType);
  try {
    return fn();
  } finally {
    ReactInstrumentation$7.debugTool.onEndLifeCycleTimer(debugID, timerType);
  }
}
...
var ReactCompositeComponentMixin = {
  ...
  mountComponent: function mountComponent(transaction, hostParent, hostContainerInfo, context) {
    ...
    !((typeof initialState === 'undefined' ? 'undefined' : _typeof(initialState)) === 'object' && !Array.isArray(initialState)) ? invariant$30(false, '%s.state: must be set to an object or null', this.getName() || 'ReactCompositeComponent') : void 0;
  ...
  performInitialMount: function performInitialMount(renderedElement, hostParent, hostContainerInfo, transaction, context) {
    ...
    if ("development" !== 'production') {
      if (debugID !== 0) {
        ...
        ReactInstrumentation$7.debugTool.onSetChildren(debugID, childDebugIDs);
      }
    }
  ...
  _processChildContext: function _processChildContext(currentContext) {
    ...
    if (childContext) {
      !(_typeof(Component.childContextTypes) === 'object') ? invariant$30(false, '%s.getChildContext(): childContextTypes must be defined in order to use getChildContext().', this.getName() || 'ReactCompositeComponent') : void 0;
      if ("development" !== 'production') {
...
function instantiateReactComponent$1(node, shouldHaveDebugID) {
  ...
  if (node === null || node === false) {
    ...
    var element = node;
    !(element && (typeof element.type === 'function' || typeof element.type === 'string')) ? invariant$29(false, 'Element type is invalid: expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s', element.type == null ? element.type : _typeof(element.type), getDeclarationErrorAddendum$4(element._owner)) : void 0;
    ...
    invariant$29(false, 'Encountered invalid React node of type %s', typeof node === 'undefined' ? 'undefined' : _typeof(node));
  }
...
function assertValidProps(component, props) {
  ...
  if (props.dangerouslySetInnerHTML != null) {
    ...
    !(_typeof(props.dangerouslySetInnerHTML) === 'object' && HTML in props.dangerouslySetInnerHTML) ? invariant$23(false, '`props.dangerouslySetInnerHTML` must be in the form `{__html: ...}`. Please visit https://fb.me/react-invariant-dangerously-set-inner-html for more information.') : void 0;
  }
  if ("development" !== 'production') {
  ...
  !(props.style == null || _typeof(props.style) === 'object') ? invariant$23(false, 'The `style` prop expects a mapping from style properties to values, not a string. For example, style={{marginRight: spacing + \'em\'}} when using JSX.%s', getDeclarationErrorAddendum$1(component)) : void 0;
}
...
index.render(react.createElement(
  'div',
  { className: 'rollup' },
  'Hello, Rollup'
